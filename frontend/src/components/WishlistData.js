...
const headCells = [
    ...
    },
    {
        ...
        label: 'Added Date (Year/Month/Date)',
    },
    {
        id: 'price',
        numeric: true,
        ...
        >
            {numSelected > 0 ? (
                ...
                <Typography
                    ...
                    component="div"
                >
                    {/*Wishlist: {totalItem} Items*/}
                    Wishlist: Coming soon
                </Typography>
            )}

            {/* Delete icon showed up if products are selected else showed nothing */}
            {numSelected > 0 ? (
                <Box sx={{display: 'flex', flexDirection: 'horizontal'}}>
                    {/*Remove selected list when clicked (add an onClick function at the <IconButton>)*/}
                    {/*Then redirect (reload) this page in the onClick function*/}
                    <Tooltip title="Delete">
                        <IconButton>
                            <DeleteIcon />
                        </IconButton>
                    </Tooltip>
                    {/*Add selected list to cart when clicked (add an onClick function at the <IconButton>)*/}
